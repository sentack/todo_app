            ...
            <div className="bg-black dark:bg-white rounded-2xl p-5 mb-6 shadow-xl">
              <div className="grid grid-cols-3 gap-3">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold text-white dark:text-black">{currency} {summary.paid.toFixed(2)}</p>
                </div>
                <div>
                  <p className="text-gray-400 dark:text-gray-600 text-xs font-medium mb-1">Remaining</p>
                  <p className="text-lg font-bold text-white dark:text-black">{currency} {summary.remaining.toFixed(2)}</p>
      ...
      <div className="p-5">
        ...
        <div className="mb-4">
          <div className="flex justify-between text-xs text-gray-500 dark:text-gray-400 mb-1.5">
            <span>Paid {currency} {Number(item.amount_paid).toFixed(2)}</span>
            <span>{pct}%</span>
          </div>
